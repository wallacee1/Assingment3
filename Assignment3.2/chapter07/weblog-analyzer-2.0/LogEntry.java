...
public class LogEntry implements Comparable<LogEntry>
{
    ...
    private static final int YEAR = 0, MONTH = 1, DAY = 2,
                             HOUR = 3, MINUTE = 4, ACCESSOUTCOME = 5;
     ...
     * @param accessOutcome The outcome(0-2)
     */
    public LogEntry(int year, int month, int day, int hour, int minute, int accessOutcome)
    {
        // The array to store the data for a single line.
        dataValues = new int[NUMBER_OF_FIELDS];
        ...
        switch (accessOutcome){
            case 0: dataValues[ACCESSOUTCOME] = 200; break;
            case 1: dataValues[ACCESSOUTCOME] = 403; break;
            default: dataValues[ACCESSOUTCOME] = 404; break;
        }
        setWhen();
    }
     ...
     * @return The access outcome from the log line.
     */
    public int getAccessoutcome() 
    {
        return dataValues[ACCESSOUTCOME];    
    }
    ...
    /**
     * Return the day.
     * @return Th day field from the log line.
     *
     */
    public int getDay()
    {
