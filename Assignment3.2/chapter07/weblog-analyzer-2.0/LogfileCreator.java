...
public class LogfileCreator
{
    ...
    public LogEntry createEntry()
    {
        ...
        //Access outcome can be either
        // 0 - which is a 200, a successful access
        // 1 - which is a 403, a forbidden document
        // 2 - which is a 404, document not found
        int accessOutcome = rand.nextInt(3);
        return new LogEntry(year, month, day, hour, minute, accessOutcome);
    }
